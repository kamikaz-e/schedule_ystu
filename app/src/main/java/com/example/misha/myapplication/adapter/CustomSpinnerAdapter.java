...
public class CustomSpinnerAdapter extends BaseAdapter implements SpinnerAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView currentNumberWeek = view.findViewById(R.id.currentNumberWeek);
        TextView currentDaysWeekRange = view.findViewById(R.id.currentDaysWeekRange);
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        List<String> arrayWeek = Arrays.asList(view.getResources().getStringArray(R.array.weeks));
        final TextView numberWeekTextView = view.findViewById(R.id.numberWeekTextView);
        final TextView dayRangeTextView = view.findViewById(R.id.dayRangeTextView);
