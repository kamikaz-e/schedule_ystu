...
public class SchedulePageSchedulePresenter extends BaseMainPresenter<SchedulePageView> implements SchedulePresenterInterface {
    ...
    public SchedulePageSchedulePresenter(int day, int positionWeek) {
        this.day = day;
